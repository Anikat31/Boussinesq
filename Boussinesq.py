...
if nu != 0:
    savePath = curr_path / f'data/bsnq/f_{f_corr:.1f}_Nb_{N_b:.1f}/forced_{isforcing}/N_{N}_Re_{re:.1f}'
else:
...
def evolve_and_save(t, uk, bk):
    ...
    if save_every == 0:
        print('Saving every    : no saving')
        print('Number of saves : 0')
    else:
    ...
    if save_every == 0:
        print('Saving interval       : no saving')
    else:
